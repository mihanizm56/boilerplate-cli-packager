...
const commandsMap = {
  ...
  [CRABuild]: 'set CI=true && npx react-app-rewired build',
  [buildCommand]:
  ...
  [fullCheckCommand]: `node ./cli/_utils/ci-utils/executor.js --command=${testCommand} && node ./cli/_utils/ci-utils/executor.js --command=${fullLintCheckCommand} && git add . && node ./cli/_utils/ci-utils/executor.js --command=${CRABuild} && node ./cli/_utils/ci-utils/executor.js --command=${buildCommand}`,
  [fullCheckSystemWindows]: `node ./cli/_utils/ci-utils/executor.js --command=${testCommand} && node ./cli/_utils/ci-utils/executor.js --command=${fullLintCheckCommand} && node ./cli/_utils/ci-utils/executor.js --command=${CRABuild} && node ./cli/_utils/ci-utils/executor.js --command=${buildCommand}`,
