...
const commandsMap = {
  ...
  [deployToDataline]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} ${projectName} dataline`,
  [deployToDatapro]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} ${projectName} datapro`,
