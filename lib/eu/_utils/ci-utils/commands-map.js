...
const moduleBuildCommand = 'platform-build';
...
const commandsMap = {
  ...
  [deployToTest]: `bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} ${projectName} ${namespace} test`,
  [deployToStage]: `bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} ${projectName} ${namespace} stage`,
  [deployToTestsStands]: `bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} ${projectName} ${namespace} test stage`,
  [deployToAllStands]: `bash ./config/deploy/template_ci.sh test ${repoName} ${deployToken} ${projectName} ${namespace} stage dataline datapro`,
};
