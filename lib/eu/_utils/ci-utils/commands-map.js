...
const commandsMap = {
  ...
  [CRABuildCommand]: {
    ...
    value: 'npx cross-env CI=false npx react-app-rewired build',
  },
  [moduleBuildCommand]: {
    title: 'Сборка platform-module',
    value:
      'set CI=true && rm -fr ./build && npx cross-env NODE_ENV=production npx webpack --config ./config/webpack/platform/production/webpack.config.js',
  },
  [testCoverateCommand]: {
