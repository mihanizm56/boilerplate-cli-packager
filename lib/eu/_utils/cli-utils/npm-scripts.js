...
module.exports.additionalCommands = [
  ...
  },
  {
    ...
    value:
      '-fr node_modules/.cache && cross-env NODE_ENV=development npx webpack --config config/webpack/platform/development/webpack-dev.config.js --watch',
    type: 'rm',
    isDetached: false,
    isCiScript: false,
    isInteractiveScript: true,
  ...
  {
    label: 'Переустановка всех npm-пакетов и восстановление package-lock.json',
    value:
      '-rf node_modules && rm -fr package-lock.json && npm i npm i --legacy-peer-deps --no-audit && npx npm-force-resolutions && npm i --legacy-peer-deps --no-audit',
    type: 'rm',
    isDetached: false,
    isCiScript: false,
    isInteractiveScript: true,
  },
  {
    ...
    value:
      'npm-force-resolutions && npm i --legacy-peer-deps --no-audit && rm -fr node_modules/.cache',
    type: 'npx',
    isDetached: false,
    isCiScript: false,
    isInteractiveScript: true,
