...
module.exports.additionalCommands = [
  ...
  },
  {
    ...
    value:
      'cross-env NODE_ENV=development npx webpack --display errors-only --config config/webpack/platform/development/webpack-dev.config.js --watch',
    type: 'npx',
    isDetached: false,
    isCiScript: false,
    isInteractiveScript: true,
  ...
  },
  {
    ...
    value: 'npx npm-force-resolutions && npm i --no-audit --legacy-peer-deps',
    type: 'npx',
    isDetached: false,
    isCiScript: false,
    isInteractiveScript: true,
