...
module.exports.additionalCommands = [
  ...
  },
  {
    ...
    value:
      'webpack --display errors-only --config ./config/webpack/platform/development/webpack-dev.config.js --watch',
    type: 'npx',
    isDetached: false,
    isCiScript: false,
    isInteractiveScript: true,
...
module.exports.extraCommands = [
  ...
  },
  {
    ...
    value:
      'build -t test -f ./config/deploy/Dockerfile ./ && docker run --name create-react-boilerplate -it -p 443:443 test',
    type: 'docker',
    isDetached: false,
    isCiScript: false,
    isInteractiveScript: true,
