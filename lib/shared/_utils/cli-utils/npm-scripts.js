...
module.exports.deployCommands = [
  ...
  {
    label:
      'Собрать докер образ и запустить под тегом passport (только mac/linux с docker)',
    value:
      'build -t passport -f ./config/deploy/Dockerfile ./ && docker run -it -p 443:443 passport',
    type: 'docker',
    isIOInherit: true,
    withLoader: false,
    isCiScript: false,
