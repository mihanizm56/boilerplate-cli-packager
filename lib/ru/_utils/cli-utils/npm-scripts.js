...
module.exports.testCommands = [
  ...
  },
  {
    ...
    value:
      'react-app-rewired build && node config/deploy/fonts-maker.js && node config/deploy/make-runtime-config.js && npx cross-env SERVER_PORT=5005 IP_LIMIT=1000 testcafe chrome:headless ./integration-tests -a "node config/production-server/static.js"',
    type: 'npx',
    isDetached: false,
    isCiScript: false,
  },
