...
module.exports.testCommands = [
  ...
  },
  {
    ...
    value:
      'npx react-app-rewired build && config/deploy/make-runtime-config.js && npx cross-env SERVER_PORT=5005 IP_LIMIT=1000 testcafe chrome:headless ./integration-tests -a "node config/production-server/static.js"',
    type: 'node',
    isDetached: false,
    isCiScript: false,
  },
