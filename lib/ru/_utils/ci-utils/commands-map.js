...
const commandsMap = {
  ...
  [buildCommand]: `set CI=true && npx cross-env NODE_ENV=production PUBLIC_URL=/ npx react-app-rewired build && node ./cli/_utils/ci-utils/executor.js --command=${buildFonts} && node ./config/deploy/make-runtime-config.js`,
