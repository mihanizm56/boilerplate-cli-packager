...
const commandsMap = {
  ...
  [integrationTestsCommand]: `node ./cli/_utils/ci-utils/executor.js --command=${buildCommand} && node ./config/deploy/make-runtime-config.js && npx cross-env SERVER_PORT=5005 IP_LIMIT=1000 testcafe chrome:headless ./integration-tests -a "node config/production-server/static.js"`,
