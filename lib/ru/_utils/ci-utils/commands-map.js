...
const commandsMap = {
  ...
  [deployToTest]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} <empty_project_name> test `,
  [deployToStage]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} <empty_project_name> stage `,
  [deployToDataline]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} <empty_project_name> dataline `,
  [deployToDatapro]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} <empty_project_name> datapro `,
  [deployToTestsStands]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} <empty_project_name> test stage `,
  [deployToAllStands]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} <empty_project_name> test stage dataline datapro `,
};
