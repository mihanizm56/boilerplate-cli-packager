...
const commandsMap = {
  ...
  [deployToTest]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} empty_var test `,
  [deployToStage]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} empty_var stage `,
  [deployToDataline]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} empty_var dataline `,
  [deployToDatapro]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} empty_var datapro `,
  [deployToTestsStands]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} empty_var test stage `,
  [deployToAllStands]: `node ./cli/_utils/ci-utils/executor.js --command=${fullCheckSystem} && bash ./config/deploy/template_ci.sh ${repoName} ${deployToken} empty_var test stage dataline datapro `,
};
